    ...
    >
      ...
      <div className="grid grid-cols-2 sm:grid-cols-4 gap-3 mt-4">
        ...
        <div className="bg-slate-50/80 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800/80 rounded-xl p-3.5">
          ...
          <p className="text-xl font-semibold tabular-nums font-mono text-emerald-600 dark:text-emerald-400 mt-1">
            {verifiedCount}
          </p>
          <p className="text-[11px] font-normal text-slate-500 dark:text-slate-400 mt-0.5">Données complètes et validées</p>
        </div>
        ...
        <div className="bg-slate-50/80 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800/80 rounded-xl p-3.5">
          ...
          <p className="text-xl font-semibold tabular-nums font-mono text-amber-600 dark:text-amber-400 mt-1">
            {partialCount}
          </p>
          <p className="text-[11px] font-normal text-slate-500 dark:text-slate-400 mt-0.5">Métadonnées secondaires absentes</p>
        </div>
        ...
        <div className="bg-slate-50/80 dark:bg-slate-900/60 border border-slate-200/80 dark:border-slate-800/80 rounded-xl p-3.5">
          ...
          <p className="text-xl font-semibold tabular-nums font-mono text-rose-600 dark:text-rose-400 mt-1">
            {reviewCount}
          </p>
          <p className="text-[11px] font-normal text-slate-500 dark:text-slate-400 mt-0.5">Paramètres requis incomplets</p>
        </div>
