...
export const TradeSchema = z.object({
  ...
  plannedRR: z.number().nullable().optional(),
  realizedRR: z.number().nullable().optional(),
  isRRComplete: z.boolean().optional(),
  ...
  entryTrigger: z.string().nullable().optional(),
  ...
  takenInPostLossWindow: z.boolean().optional(),
  warningAcknowledged: z.boolean().optional(),

  tags: z.array(z.string()),

  tradingViewUrl: z.string().nullable().optional(),
